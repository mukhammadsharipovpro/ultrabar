...
import {burgerApp7} from '../assets/products';

const UltraFunTabCartItemComponent = ({item}) => {
  ...
  const productImage = burgerApp7.find(p => p.name === item.name)?.image;
...
export default UltraFunTabCartItemComponent;
