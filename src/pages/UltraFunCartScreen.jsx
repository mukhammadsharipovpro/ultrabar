...
import UltraFunTabCartItemComponent from '../components/UltraFunTabCartItemComponent';
import UltraFunComponent from '../components/UltraFunComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <UltraFunTabCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
